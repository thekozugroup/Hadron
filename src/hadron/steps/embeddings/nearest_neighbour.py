...
from hadron.steps import GlobalStep, StepInput
...
class FaissNearestNeighbour(GlobalStep):
    ...
    Examples:
        ...
        ```python
        from hadron.models import SentenceTransformerEmbeddings
        from hadron.pipeline import Pipeline
        from hadron.steps import EmbeddingGeneration, FaissNearestNeighbour, LoadDataFromHub
    ...
    def load(self) -> None:
        ...
        if importlib.util.find_spec("faiss") is None:
            raise ImportError(
                ...
                " 'hadron[faiss-cpu]' or 'hadron[faiss-gpu]'`."
            )
