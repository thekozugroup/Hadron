...
from hadron.steps import StepInput
from hadron.steps.tasks import TextClassification
from hadron.steps.tasks.base import GlobalTask
...
class TextClustering(TextClassification, GlobalTask):
    ...
    Examples:
        ...
        from hadron.steps import UMAP, DBSCAN, TextClustering
