...
from hadron.steps.tasks.base import ImageTask
...
class ImageGeneration(ImageTask):
    ...
    It works with any of the `image_generation` defined under `hadron.models.image_generation`,
    ...
    `Distiset.transform_columns_to_image`. Take a look at the `Image Generation with hadron`
    ...
    Examples:
        ...
        ```python
        from hadron.steps.tasks import ImageGeneration
        from hadron.models.image_generation import InferenceEndpointsImageGeneration
    ...
    def save(self, **kwargs):
        if not self.save_artifacts:
            from hadron.utils.serialization import _Serializable
