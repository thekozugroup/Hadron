...
class APIGenExecutionChecker(Step):
    ...
    Examples:
        ...
        ```python
        from hadron.steps.tasks import APIGenExecutionChecker

        # For the libpath you can use as an example the file at the tests folder:
        # ../hadron/tests/unit/steps/tasks/apigen/_sample_module.py
        task = APIGenExecutionChecker(
            libpath="../hadron/tests/unit/steps/tasks/apigen/_sample_module.py",
        )
        task.load()
