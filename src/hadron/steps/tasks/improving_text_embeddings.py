...
from hadron.steps.tasks.base import GeneratorTask, Task
from hadron.typing import ChatType, GeneratorStepOutput
...
class _EmbeddingDataGeneration(_JSONFormatter, Task, ABC):
    ...
    Attributes:
        ...
        _template_name: The name of the Jinja2 template file within the
            `hadron/steps/tasks/templates/improving_text_embeddings` directory.
    """
...
class EmbeddingTaskGenerator(GeneratorTask):
    ...
    Attributes:
        ...
        flatten_tasks: Whether to flatten the tasks i.e. since a list of tasks is generated by the
            ...
            meaning that running this task with `num_generations=1` will return a `hadron.Distiset`
            with one row only containing a list with around 20 tasks; otherwise, if set to `True`, it
            will return a `hadron.Distiset` with around 20 rows, each containing one task.
    ...
    Examples:
        ...
        from hadron.steps.tasks import EmbeddingTaskGenerator
...
class GenerateTextRetrievalData(_EmbeddingDataGeneration):
    ...
    Examples:
        ...
        ```python
        from hadron.pipeline import Pipeline
        from hadron.steps.tasks import EmbeddingTaskGenerator, GenerateTextRetrievalData
...
class GenerateShortTextMatchingData(_EmbeddingDataGeneration):
    ...
    Examples:
        ...
        ```python
        from hadron.pipeline import Pipeline
        from hadron.steps.tasks import EmbeddingTaskGenerator, GenerateShortTextMatchingData
...
class GenerateLongTextMatchingData(_EmbeddingDataGeneration):
    ...
    Examples:
        ...
        ```python
        from hadron.pipeline import Pipeline
        from hadron.steps.tasks import EmbeddingTaskGenerator, GenerateLongTextMatchingData
...
class GenerateTextClassificationData(_EmbeddingDataGeneration):
    ...
    Examples:
        ...
        ```python
        from hadron.pipeline import Pipeline
        from hadron.steps.tasks import EmbeddingTaskGenerator, GenerateTextClassificationData
...
class MonolingualTripletGenerator(_EmbeddingDataGenerator):
    ...
    Examples:
        ...
        ```python
        from hadron.pipeline import Pipeline
        from hadron.steps.tasks import MonolingualTripletGenerator
...
class BitextRetrievalGenerator(_EmbeddingDataGenerator):
    ...
    Examples:
        ...
        ```python
        from hadron.pipeline import Pipeline
        from hadron.steps.tasks import BitextRetrievalGenerator
