...
from hadron.steps.tasks.magpie.base import MagpieBase

if TYPE_CHECKING:
    from hadron.typing import ChatType, GeneratorStepOutput, StepColumns
...
class MagpieGenerator(GeneratorTask, MagpieBase):
    ...
    Examples:
        ...
        ```python
        from hadron.models import TransformersLLM
        from hadron.steps.tasks import MagpieGenerator
