...
from hadron.steps.tasks.base import GeneratorTask
from hadron.steps.tasks.evol_instruct.utils import GENERATION_MUTATION_TEMPLATES
from hadron.utils.lists import flatten_responses

if TYPE_CHECKING:
    from hadron.typing import ChatType, GeneratorStepOutput, LLMStatistics
...
class EvolInstructGenerator(GeneratorTask):
    ...
    Examples:
        ...
        ```python
        from hadron.steps.tasks import EvolInstructGenerator
    ...
    def process(self, offset: int = 0) -> "GeneratorStepOutput":  # NOQA: C901, type: ignore
        ...
        while len(instructions) < self.num_instructions:
            ...
            if not self.generate_answers and len(instructions[-mutation_no:]) > 0:
                ...
                for mutated_instruction in instructions[-mutation_no:]:
                    ...
                    mutated_instruction["hadron_metadata"] = {
        ...
        if self.generate_answers:
            ...
            for instruction, answer in zip(instructions, answers):
                ...
                formatted_output["hadron_metadata"] = {
