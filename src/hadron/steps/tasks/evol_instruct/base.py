...
from hadron.steps.tasks.evol_instruct.utils import MUTATION_TEMPLATES
from hadron.typing import ChatType
from hadron.utils.lists import flatten_responses

if TYPE_CHECKING:
    from hadron.typing import LLMStatistics, StepOutput
...
class EvolInstruct(Task):
    ...
    Examples:
        ...
        ```python
        from hadron.steps.tasks import EvolInstruct
