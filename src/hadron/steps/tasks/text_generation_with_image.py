...
from hadron.steps.tasks.text_generation import (
    TextGeneration,
    check_column_in_template,
)
from hadron.utils.image import image_to_str

if TYPE_CHECKING:
    from PIL.Image import Image

    from hadron.typing import ChatType, StepColumns
...
class TextGenerationWithImage(TextGeneration):
    ...
    Examples:
        ...
        ```python
        from hadron.steps.tasks import TextGenerationWithImage
