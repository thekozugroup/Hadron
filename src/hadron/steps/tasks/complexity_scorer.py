...
class ComplexityScorer(Task):
    ...
    Examples:
        ...
        ```python
        from hadron.steps.tasks import ComplexityScorer
        ...
        # result
        # [{'instructions': ['plain instruction', 'highly complex instruction'], 'model_name': 'test', 'scores': [1, 5], 'hadron_metadata': {'raw_output_complexity_scorer_0': 'output'}}]
        ```
        ...
        # result
        # [{'instructions': ['plain instruction', 'highly complex instruction'], 'model_name': 'test', 'scores': [1, 2], 'hadron_metadata': {'raw_output_complexity_scorer_0': '{ \\n  "scores": [\\n    1, \\n    2\\n  ]\\n}'}}]
        ```
