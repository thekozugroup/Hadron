...
from hadron.typing import FormattedInput

if TYPE_CHECKING:
    from hadron.typing import StepColumns
...
def _parse_docstring(docstring: str) -> Tuple[str, str]:
    ...
    Raises:
        HadronUserError: if the docstring doesn't follow the expected format or if
    ...
    try:
        ...
        raise HadronUserError(_DOCSTRING_FORMATTING_FUNCTION_ERROR, page="") from e
...
def _validate_templates(
    ...
    Raises:
        HadronUserError: if the system prompt or the user message template contain
