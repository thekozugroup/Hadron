...
if TYPE_CHECKING:
    from hadron.steps.base import GeneratorStepOutput
...
class DataSampler(GeneratorStep):
    ...
    Examples:
        ...
        ```python
        from hadron.steps import DataSampler
        ...
        from hadron.steps import LoadDataFromDicts, DataSampler
        from hadron.steps.tasks.apigen.utils import PrepareExamples
