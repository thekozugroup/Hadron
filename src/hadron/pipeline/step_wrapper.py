...
from hadron.constants import LAST_BATCH_SENT_FLAG
from hadron.errors import HADRON_DOCS_URL
...
from hadron.steps.base import GeneratorStep, Step, _Step
from hadron.typing import StepLoadStatus
            ...
            try:
                ...
                if self.step.is_global:
                    ...
                    data = (
                        batch.data
                        if isinstance(
                            e, HadronOfflineBatchGenerationNotFinishedException
                        )
                        else None
                    )
...
class _StepWrapperException(Exception):
    ...
    def __init__(
        ...
        self.message = f"{message}\n\nFor further information visit '{HADRON_DOCS_URL}api/pipeline/step_wrapper'"
        self.step = step
        self.code = code
