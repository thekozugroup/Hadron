...
from hadron.llms import LLM, InferenceEndpointsLLM
from hadron.pipeline import Pipeline
from hadron.pipeline.templates.base import BasePipelineTemplate
from hadron.steps import ExpandColumns, KeepColumns
from hadron.steps.tasks import SelfInstruct, TextGeneration
...
class DatasetInstructionResponsePipeline(BasePipelineTemplate):
    ...
    Examples:
        ...
        from hadron.pipeline import DatasetInstructionResponsePipeline
