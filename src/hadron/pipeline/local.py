...
from hadron.constants import SIGINT_HANDLER_CALLED_ENV_NAME
...
from hadron.pipeline.step_wrapper import _StepWrapper, _StepWrapperException
from hadron.utils.logging import setup_logging, stop_logging
from hadron.utils.ray import script_executed_in_ray_cluster
...
class Pipeline(BasePipeline):
    ...
    def _error_callback(self, e: BaseException) -> None:
        ...
        if isinstance(
            e.subprocess_exception, HadronOfflineBatchGenerationNotFinishedException
        ):
            self._logger.info(
