...
TEMPLATE_HADRON_DATASET_CARD_PATH = Path(__file__).parent / "hadron_template.md"
...
class HadronDatasetCard(DatasetCard):
    """A `DatasetCard` subclass that uses the Hadron template by default."""

    default_template_path = TEMPLATE_HADRON_DATASET_CARD_PATH
