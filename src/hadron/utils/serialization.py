...
from hadron.mixins.runtime_parameters import RuntimeParametersMixin
...
HADRON_FILENAME = "hadron-file.json"
...
_OLD_IMPORT_MODULE_ATTR: Dict[Tuple[str, str], Tuple[str, str]] = {
    ("hadron.pipeline.base", "_Batch"): ("hadron.pipeline.batch", "_Batch"),
    ("hadron.pipeline.base", "_BatchManager"): (
        "hadron.pipeline.batch_manager",
        "_BatchManager",
    ),
    ("hadron.pipeline.base", "_BatchManagerStep"): (
        "hadron.pipeline.batch_manager",
        "_BatchManagerStep",
    ),
}
