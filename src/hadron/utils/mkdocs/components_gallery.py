...
from hadron.utils.export_components_info import export_components_info
...
_STEP_CATEGORY_TABLE_DESCRIPTION = [
    ...
    "    The gallery page showcases the different types of components within `hadron`.",
    "",
]
...
class ComponentsGalleryPlugin(BasePlugin[ComponentsGalleryConfig]):
    """A MkDocs plugin to generate a components gallery page for `hadron` components.
    ...
    def on_files(
        ...
        for relative_file_path in [
            ...
            *self.file_paths["pipelines"],
            ...
            file.generated_by = "hadron/components-gallery"  # type: ignore
            files.append(file)
