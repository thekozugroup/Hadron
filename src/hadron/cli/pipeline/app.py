...
app = typer.Typer(help="Commands to run and inspect Hadron pipelines.")

ConfigOption = Annotated[
    str, typer.Option(help="Path or URL to the Hadron pipeline configuration file.")
]
...
@app.command(name="run", help="Run a Hadron pipeline.")
def run(
    ...
    config: Optional[str] = typer.Option(
        None, help="Path or URL to the hadron pipeline configuration file."
    ),
    script: Optional[str] = typer.Option(
        None,
        help="URL pointing to a python script containing a hadron pipeline.",
    ),
    ...
    from hadron.cli.pipeline.utils import get_pipeline, parse_runtime_parameters
...
@app.command(name="info", help="Get information about a Hadron pipeline.")
def info(config: ConfigOption) -> None:
    from hadron.cli.pipeline.utils import display_pipeline_information, get_pipeline
