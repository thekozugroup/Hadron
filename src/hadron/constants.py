...
HADRON_METADATA_KEY: Final[str] = "hadron_metadata"

# Cache
BASE_CACHE_DIR = Path.home() / ".cache" / "hadron"
...
PIPELINE_NAME_ENV_NAME = "HADRON_PIPELINE_NAME"
PIPELINE_CACHE_ID_ENV_NAME = "HADRON_PIPELINE_CACHE_ID"
