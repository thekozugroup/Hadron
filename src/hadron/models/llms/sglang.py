...
from hadron.steps.tasks.structured_outputs.utils import schema_as_dict
...
class SGLang(LLM, MagpieChatTemplateMixin, CudaDevicePlacementMixin):
    ...
    Examples:
        ...
        ```python
        from hadron.models.llms import SGLang
...
class ClientSGLang(OpenAILLM, MagpieChatTemplateMixin):
    ...
    Examples:
        ...
        ```python
        from hadron.models.llms import ClientSGLang
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Please install it using `pip install 'hadron[hf-transformers]'`."
            ) from ie
