...
from hadron.errors import HadronNotImplementedError, HadronUserError
...
class LLM(RuntimeParametersModelMixin, BaseModel, _Serializable, ABC):
    """Base class for `LLM`s to be used in `hadron` framework.
    ...
    def load(self) -> None:
        ...
        self._logger = logging.getLogger(f"hadron.llm.{self.model_name}")
    ...
    def generate_outputs(
        ...
        **kwargs: Any,
        ...
        if self.use_offline_batch_generation:
            ...
            # This will raise `HadronOfflineBatchGenerationNotFinishedException` right away
    ...
    def _offline_batch_generate_polling(
        ...
        **kwargs: Any,
        ...
        while True:
            ...
            except HadronOfflineBatchGenerationNotFinishedException as e:
                self._logger.info(
    ...
    def get_last_hidden_states(
        ...
        """
        # TODO: update to use `HadronNotImplementedError`
    ...
    def offline_batch_generate(
        ...
        **kwargs: Any,
        ...
        should raise a `HadronOfflineBatchGenerationNotFinishedException`. This exception
        ...
        Returns:
            A list containing the generations for each input.
        """
        raise HadronNotImplementedError(
...
class AsyncLLM(LLM):
    ...
    def _prepare_structured_output(  # type: ignore
        ...
        """
        from hadron.steps.tasks.structured_outputs.instructor import (
            prepare_instructor,
        )
    ...
    def _prepare_kwargs(
        ...
        if not (inspect.isclass(schema) and issubclass(schema, BaseModel)):
            from hadron.steps.tasks.structured_outputs.utils import (
