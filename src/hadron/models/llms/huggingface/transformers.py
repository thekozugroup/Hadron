...
from hadron.utils.huggingface import HF_TOKEN_ENV_VAR
...
if TYPE_CHECKING:
    ...
    from hadron.typing import HiddenState
...
class TransformersLLM(LLM, MagpieChatTemplateMixin, CudaDevicePlacementMixin):
    ...
    Examples:
        ...
        ```python
        from hadron.models.llms import TransformersLLM
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "Transformers is not installed. Please install it using `pip install 'hadron[hf-transformers]'`."
            ) from ie
