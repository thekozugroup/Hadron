...
from hadron.typing import StructuredOutputType
from hadron.utils.huggingface import HF_TOKEN_ENV_VAR, get_hf_token
    ...
    def load(self) -> None:  # noqa: C901
        ...
        try:
            ...
            raise ImportError(
                ...
                " `pip install 'hadron[hf-inference-endpoints]'`."
            ) from ie
