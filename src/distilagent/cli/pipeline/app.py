...
def run(
    ...
    config: Optional[str] = typer.Option(
        None, help="Path or URL to the distilagent pipeline configuration file."
    ),
    script: Optional[str] = typer.Option(
        None,
        help="URL pointing to a python script containing a distilagent pipeline.",
    ),
    ...
    from distilagent.cli.pipeline.utils import get_pipeline, parse_runtime_parameters
