...
from distilagent.typing import StructuredOutputType
from distilagent.utils.huggingface import HF_TOKEN_ENV_VAR, get_hf_token
    ...
    def load(self) -> None:  # noqa: C901
        ...
        try:
            ...
            raise ImportError(
                ...
                " `pip install 'distilagent[hf-inference-endpoints]'`."
            ) from ie
