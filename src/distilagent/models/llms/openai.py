...
if TYPE_CHECKING:
    ...
    from distilagent.typing.models import (
        LLMStatistics,
        Logprob,
        StandardInput,
        StructuredInput,
...
class OpenAILLM(OpenAIBaseClient, AsyncLLM):
    ...
    Attributes:
        ...
        structured_output: a dictionary containing the structured output configuration configuration
            ...
            `InstructorStructuredOutputType` from `distilagent.steps.tasks.structured_outputs.instructor`.
    ...
    Examples:
        ...
        ```python
        from distilagent.models.llms import OpenAILLM
    ...
    def _create_batch_files(
        ...
        for file_no, buffer in enumerate(
            ...
            try:
                # TODO: add distilagent pipeline name and id
