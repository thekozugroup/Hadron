...
class vLLM(LLM, MagpieChatTemplateMixin, CudaDevicePlacementMixin):
    ...
    Examples:
        ...
        ```python
        from distilagent.models.llms import vLLM
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "vLLM is not installed. Please install it using `pip install 'distilagent[vllm]'`."
            ) from ie
...
class ClientvLLM(OpenAILLM, MagpieChatTemplateMixin):
    ...
    Examples:
        ...
        ```python
        from distilagent.models.llms import ClientvLLM
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                " `pip install 'distilagent[openai]'`."
            ) from ie
        ...
        try:
            ...
            raise ImportError(
                ...
                "Please install it using `pip install 'distilagent[hf-transformers]'`."
            ) from ie
