...
from distilagent.typing import StandardInput

if TYPE_CHECKING:
    from distilagent.mixins.runtime_parameters import RuntimeParametersNames
...
class MixtureOfAgentsLLM(AsyncLLM):
    ...
    Examples:
        ...
        ```python
        from distilagent.models.llms import MixtureOfAgentsLLM, InferenceEndpointsLLM
