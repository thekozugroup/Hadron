...
from distilagent.utils.huggingface import HF_TOKEN_ENV_VAR
...
if TYPE_CHECKING:
    ...
    from distilagent.typing import HiddenState
...
class TransformersLLM(LLM, MagpieChatTemplateMixin, CudaDevicePlacementMixin):
    ...
    Examples:
        ...
        ```python
        from distilagent.models.llms import TransformersLLM
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "Transformers is not installed. Please install it using `pip install 'distilagent[hf-transformers]'`."
            ) from ie
