...
from distilagent.utils.export_components_info import export_components_info
...
_STEP_CATEGORY_TABLE_DESCRIPTION = [
    ...
    "    The gallery page showcases the different types of components within `distilagent`.",
    "",
]
    ...
    def on_files(
        ...
        for relative_file_path in [
            ...
            *self.file_paths["pipelines"],
            ...
            file.generated_by = "distilagent/components-gallery"  # type: ignore
            files.append(file)
