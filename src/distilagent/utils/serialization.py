...
from distilagent.mixins.runtime_parameters import RuntimeParametersMixin
...
_OLD_IMPORT_MODULE_ATTR: Dict[Tuple[str, str], Tuple[str, str]] = {
    ("distilagent.pipeline.base", "_Batch"): ("distilagent.pipeline.batch", "_Batch"),
    ("distilagent.pipeline.base", "_BatchManager"): (
        "distilagent.pipeline.batch_manager",
        "_BatchManager",
    ),
    ("distilagent.pipeline.base", "_BatchManagerStep"): (
        "distilagent.pipeline.batch_manager",
        "_BatchManagerStep",
    ),
}
