...
from distilagent.pipeline.templates.base import BasePipelineTemplate
from distilagent.steps.base import _Step
from distilagent.steps.tasks.base import _Task
...
def export_components_info() -> ComponentsInfo:
    ...
    format. This information can be used to generate `distilagent` components documentation,
...
def _get_image_generation_models() -> List[Type["ImageGenerationModel"]]:
    ...
    Returns:
        The list of all the classes under `distilagent.models.image_generation` that are not abstract classes.
    """
    return [
        igm_type
