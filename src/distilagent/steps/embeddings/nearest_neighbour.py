...
from distilagent.steps import GlobalStep, StepInput
...
class FaissNearestNeighbour(GlobalStep):
    ...
    Examples:
        ...
        ```python
        from distilagent.models import SentenceTransformerEmbeddings
        from distilagent.pipeline import Pipeline
        from distilagent.steps import EmbeddingGeneration, FaissNearestNeighbour, LoadDataFromHub
    ...
    def load(self) -> None:
        ...
        if importlib.util.find_spec("faiss") is None:
            raise ImportError(
                ...
                " 'distilagent[faiss-cpu]' or 'distilagent[faiss-gpu]'`."
            )
