...
def merge_distilabel_metadata(
    *output_dicts: Dict[str, Any],
    ...
    Args:
        *output_dicts: Variable number of dictionaries or lists containing distilagent metadata.

    Returns:
        A merged dictionary or list containing all the distilagent metadata.
    """
