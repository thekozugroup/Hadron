...
from distilagent.steps.tasks.text_generation import (
    TextGeneration,
    check_column_in_template,
)
from distilagent.utils.image import image_to_str
...
class TextGenerationWithImage(TextGeneration):
    ...
    Examples:
        ...
        ```python
        from distilagent.steps.tasks import TextGenerationWithImage
