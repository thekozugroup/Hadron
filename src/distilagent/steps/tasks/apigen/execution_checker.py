...
class APIGenExecutionChecker(Step):
    ...
    Examples:
        ...
        ```python
        from distilagent.steps.tasks import APIGenExecutionChecker

        # For the libpath you can use as an example the file at the tests folder:
        # ../distilagent/tests/unit/steps/tasks/apigen/_sample_module.py
        task = APIGenExecutionChecker(
            libpath="../distilagent/tests/unit/steps/tasks/apigen/_sample_module.py",
        )
        task.load()
