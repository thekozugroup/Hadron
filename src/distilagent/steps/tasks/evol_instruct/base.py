...
from distilagent.steps.tasks.evol_instruct.utils import MUTATION_TEMPLATES
from distilagent.typing import ChatType
from distilagent.utils.lists import flatten_responses

if TYPE_CHECKING:
    from distilagent.typing import LLMStatistics, StepOutput
...
class EvolInstruct(Task):
    ...
    Examples:
        ...
        ```python
        from distilagent.steps.tasks import EvolInstruct
