...
from distilagent.steps.tasks.base import ImageTask
...
class ImageGeneration(ImageTask):
    ...
    It works with any of the `image_generation` defined under `distilagent.models.image_generation`,
    ...
    `Distiset.transform_columns_to_image`. Take a look at the `Image Generation with distilagent`
    ...
    Examples:
        ...
        ```python
        from distilagent.steps.tasks import ImageGeneration
        from distilagent.models.image_generation import InferenceEndpointsImageGeneration
        ...
        from distilagent.models.image_generation import OpenAIImageGeneration
    ...
    def load(self) -> None:
        from distilagent.models.image_generation.utils import image_from_str
    ...
    def save(self, **kwargs):
        if not self.save_artifacts:
            from distilagent.utils.serialization import _Serializable
