...
:class:`~distilagent.steps.tasks.autoreason.tournament.TournamentRunner`. To
...
# running loops. This mirrors ``distilagent.models.llms.base``.
...
class AutoReasonedGeneration(Task):
    ...
    :class:`~distilagent.steps.tasks.autoreason.tournament.TournamentRunner`
