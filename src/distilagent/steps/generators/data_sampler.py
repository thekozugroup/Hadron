...
if TYPE_CHECKING:
    from distilagent.steps.base import GeneratorStepOutput
...
class DataSampler(GeneratorStep):
    ...
    Examples:
        ...
        ```python
        from distilagent.steps import DataSampler
        ...
        from distilagent.steps import LoadDataFromDicts, DataSampler
        from distilagent.steps.tasks.apigen.utils import PrepareExamples
