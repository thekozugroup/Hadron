...
from distilagent.steps.base import GeneratorStep, _Step
...
from distilagent.utils.notebook import in_notebook
from distilagent.utils.serialization import (
    _Serializable,
    read_json,
)
from distilagent.utils.typing_ import (
...
if TYPE_CHECKING:
    ...
    from distilagent.steps.base import Step
...
class BasePipeline(ABC, RequirementsMixin, _Serializable):
    ...
    def __init__(
        ...
        self._logger = logging.getLogger("distilagent.pipeline")
    ...
    def dump(self, **kwargs: Any) -> Dict[str, Any]:
        return {
            "distilagent": {"version": __version__},
            "pipeline": {
                "name": self.name,
