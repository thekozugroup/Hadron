...
from distilagent.llms import LLM, InferenceEndpointsLLM
from distilagent.pipeline import Pipeline
from distilagent.pipeline.templates.base import BasePipelineTemplate
from distilagent.steps import ExpandColumns, KeepColumns
from distilagent.steps.tasks import SelfInstruct, TextGeneration
...
class DatasetInstructionResponsePipeline(BasePipelineTemplate):
    ...
    Examples:
        ...
        from distilagent.pipeline import DatasetInstructionResponsePipeline
